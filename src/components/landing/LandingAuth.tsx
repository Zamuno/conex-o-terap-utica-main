    ...
    const HeroView = () => (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="space-y-4 pt-4">
                <Button
                    variant="outline"
                    className="w-full h-14 rounded-2xl text-lg font-medium shadow-sm hover:shadow-md transition-all relative bg-white hover:bg-gray-50 text-gray-700 border-gray-200"
                ...
                <Button
                    variant="secondary"
                    className="w-full h-14 rounded-2xl text-lg font-medium bg-secondary/50 hover:bg-secondary/80 text-secondary-foreground transition-all"
            ...
            <div className="text-center pt-2">
                ...
                >
                    Não tem conta? <span className="font-semibold underline">Cadastre-se</span>
                </button>
            </div>

            <p className="text-center text-[10px] text-muted-foreground/50 pt-8 max-w-[250px] mx-auto leading-tight">
                Protegido por reCAPTCHA e sujeito à Política de Privacidade e Termos de Uso do 149PSI.
            </p>
        </div>
    );
